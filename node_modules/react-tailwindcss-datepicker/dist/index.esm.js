...
const Days = ({ calendarData, onClickPreviousDays, onClickDay, onClickNextDays }) => {
    ...
    return (React.createElement("div", { className: "grid grid-cols-7 gap-y-0.5 my-1" },
        ...
        calendarData.days.next.map((item, index) => (React.createElement("button", { type: "button", key: index, disabled: isDateDisabled(item, "next"), className: "flex items-center justify-center text-gray-400 h-12 w-12 lg:w-10 lg:h-10", onClick: () => handleClickDay(item, "next"), onMouseOver: () => {
                hoverDay(item, "next");
            } }, item)))));
};
...
const Calendar = ({ date, minDate, maxDate, onClickPrevious, onClickNext, changeMonth, changeYear }) => {
    ...
    return (React.createElement("div", { className: "w-full md:w-[297px] md:min-w-[297px]" },
        ...
        React.createElement("div", { className: "px-0.5 sm:px-2 mt-0.5 min-h-[285px]" },
            ...
            showYears && (React.createElement(Years, { year: year, minYear: minYear, maxYear: maxYear, clickYear: clickYear })),
...
const Input = (e) => {
    ...
    const handleInputChange = useCallback((e) => {
        ...
        if (start.length === 10 &&
            ...
            (require$$0(start).isBefore(end) || asSingle)) {
            changeDatepickerValue({
                startDate: start,
                endDate: end
            }, e.target);
